...
public class PolygonMapView extends MapView {
	...
	private PolygonMapView.OnLongpressListener longpressListener;
	
	public PolygonMapView(Context context, String apiKey) {
		super(context, apiKey);
	}

	public PolygonMapView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PolygonMapView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public void setOnLongpressListener(PolygonMapView.OnLongpressListener listener) {
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
		   ...
		   public void run() {
			   ...
			   */
			   ...
			   longpressListener.onLongpress(PolygonMapView.this, longpressLocation);
		   	}
		   }, LONGPRESS_THRESHOLD);
